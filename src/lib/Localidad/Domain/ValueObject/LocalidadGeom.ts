...
/**
 * Value Object que representa la geometría de una localidad.
 * Asegura que el valor sea un string en formato WKB válido.
 */
export class LocalidadGeom {
...
constructor(value: string) {
  ...
  if (!this.isValid(cleanValue)) {
    throw new Error(`Geom inválido (no es un WKB válido): "${value}"`);
  }
  ...
  public equals(other: LocalidadGeom): boolean {
